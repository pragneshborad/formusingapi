...
defined('SYSTEM_NAME')      OR define('SYSTEM_NAME', 'angularcrud');
...
defined('LOGO_URL')      OR define('LOGO_URL', 'https://demo1.saptez.com/angularcrud/assets/images/header/logo_main.png');
defined('BASE_URL')      OR define('BASE_URL', 'http://192.168.1.2:4300/angularcrud/');
defined('BASE_PATH')      OR define('BASE_PATH', 'http://192.168.1.2/angularcrud/api/assets/');
defined('UPLOAD_URL')      OR define('UPLOAD_URL', substr(FCPATH, 0, -4).'api/assets/');
defined('IMAGETOOL')      OR define('IMAGETOOL', 'http://192.168.1.2/angularcrud/api/image-tool/index.php?src=');
defined('FRONT_URL')      OR define('FRONT_URL', 'http://192.168.1.2:4300/angularcrud/');
defined('ADMIN_URL')      OR define('ADMIN_URL', 'http://192.168.1.2/angularcrud/admin/');
